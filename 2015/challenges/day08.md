...
However, it is important to realize the difference between the number of characters i*n the code representation of the string literal* and the number of characters *in the in-memory string itself*.
